    ...
    <div class="container" style="background-color: silver">
        <div class="table-responsive">
            ...
            <form id="formku" action="bukti.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="cont">
                    <span> Nama</span>
                    <input disabled="disabled" type="text" name="nama" value="<?php echo $_SESSION['nama']?>">
                    <span>Email</span>
                    <input disabled="disabled" type="text" name="email" value="<?= $p['email'] ?>">
                ...
                <a href="keranjang.php" class="btn btn-primary" style="background: #4CAF50; margin-top: 10px;">Kembali</a>
                <input type="submit" value="Pesan Sekarang" name="finish" style="background: #4CAF50; margin-top: 10PX;" class="btn btn-success"/>
                </div>
            </form>
        </div>
    </div>  
