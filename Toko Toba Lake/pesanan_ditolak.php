    ...
    <div class="check">  
        <div class="col-md-12 cart-items" style="background-color: white">
                 <nav arial-label="breadcrumb">
       			  ...
       			  <h1><u><a href="pesanan.php">Daftar Pesanan</a></u></h1>  
                <a href="pesanan_dikirim.php"  class="btn btn-primary" style="font-size: 10px;">Daftar Pesanan Telah dikirim</a>
                 <a href="pesanan_ditolak.php" class="btn btn-danger" style="font-size: 10px;">Daftar Pesanan Ditolak</a>
                        ...
                        $query = mysqli_query($koneksi, "select * from pemesanan where id_user = '$id_user' and status='Pesanan Ditolak'");
