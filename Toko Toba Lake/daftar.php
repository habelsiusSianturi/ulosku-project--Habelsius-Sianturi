...
<ul class="tp-hd-lft wow fadeInDown animated" data-wow-delay="0.5s">
 <form id="login" action="registerproses.php" method="POST" style="margin-top: 90px; color: black;">
    ...
    <fieldset id="actions">
        ...
        <input type="submit" value="Daftar" name="daftar" style="height: 40px;margin-left: 12px">
            <div class="utilities" style="text-align:center; margin-top: 10px;">
                  <span class="glyphicon glyphicon-hand-right"></span>&nbsp
              <a href="login.php" style="text-decoration: none; cursor: pointer; font-family:'Sofia';font-size: 18px"><b>Login Disini</b></a>
            </div>
...
h1 {
    text-shadow: 1px 1px 0 rgba(255, 255, 255, .7), 0px 2px 0 rgba(0, 0, 0, .5);
