...
<div id="wrapper">
    ...
    <?php
			if($_POST['finish']){
				...
				$tanggal = date('Y-m-d');
				$sql  = mysqli_query($koneksi, "INSERT INTO pemesanan VALUES('', '$id_user', '$id_produk', '$jumlah', '$total','$alamat','$nohp', '$bukti', '$tanggal', 'Belum Dikirim')") or die(mysqli_error($koneksi));
